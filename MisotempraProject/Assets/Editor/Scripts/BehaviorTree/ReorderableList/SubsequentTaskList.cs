...
namespace Editor
{
	...
	namespace BehaviorTree
	{
		...
		namespace NodeEditor
		{
			...
			{
				public class SubsequentTaskList : ClassList
				{
					BTBaseNodeEditor m_editor;

					public SubsequentTaskList(BTBaseNodeEditor editor, SerializedProperty useProperty, System.Type baseType, string title)
					...
					protected override void InitializeList(Type baseType)
					{
						...
						list.onSelectCallback += select =>
						{
							...
							{
								m_editor.SelectSubsequentTask(className, element.FindPropertyRelative("m_jsonData"));
							}
						};
						...
						list.onRemoveCallback += list =>
						{
							...
							m_editor.UnselectSubsequentTask();
						};
					}
					...
					public override void AddCallback(string name)
					{
						...
						back.FindPropertyRelative("m_key").stringValue = "";
