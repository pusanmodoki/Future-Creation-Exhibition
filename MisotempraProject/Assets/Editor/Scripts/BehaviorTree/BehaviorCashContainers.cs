		...
		namespace CashContainer
		{
			namespace Detail
			{
				public class BaseCashContainer
				{
					...
					protected BaseCashContainer(string nodeName, Vector2 position)
					{
						m_nodeName = nodeName;
			...
			public class RootCashContainer : Detail.BaseCashContainer
			{
				...
				public RootCashContainer(string nodeName, string className, Vector2 position) : base(nodeName, position)
				{
			...
			public class TaskCashContainer : Detail.BaseCashContainer
			{
				...
				public TaskCashContainer() : base("", Vector2.zero)
				{
			...
			public class CompositeCashContainer : Detail.BaseCashContainer
			{
				...
				public CompositeCashContainer(string nodeName, string className, Vector2 position) : base(nodeName, position)
				{
					m_className = className;
				}
			...
			public class ParallelCashContainer : CompositeCashContainer
			{
				...
				public ParallelCashContainer() : base("", "", Vector2.zero)
				{
